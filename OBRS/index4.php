		...
		?>
			...
			<!--				<ul class="icons">
					...
					-->		<ul class="tabular">
								<li>
                  <h3>Address</h3>
									Near MGM Campus, Namaskar Chauk Nanded 431605
								</li>
								<li>
									<h3>Mail</h3>
									<a href="#">swapnilpatil@gmail.com</a>
								</li>
								<li>
									<h3>Phone</h3>
									8551899635
					...
					<ul class="copyright">
						<li>&copy; 2020 BookMyBusTicket. All rights reserved at SP softs</li>
